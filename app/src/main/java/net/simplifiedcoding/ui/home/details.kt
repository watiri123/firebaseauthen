...
@Composable
fun Details(viewModel: AuthViewModel?, navController: NavHostController) {
                            ...
                            modifier = Modifier
                                .clickable {
                                    navController.navigate(ROUTE_HOME) {
                                        popUpTo(ROUTE_PAGE) { inclusive = true }
                                    }
                                }
                        )
                    }
...
@Composable
fun DetailsPreviewLight() {
    AppTheme {
        Details(null, rememberNavController())
    }
}
